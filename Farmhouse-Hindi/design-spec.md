...
- Lintel: RCC 9"×9", ओपनिंग से 6" दोनों तरफ ज़्यादा
...
| हिस्सा | डिटेल |
|---------|--------|
| कमरा | 20 ft × 16 ft = 320 sq ft बंद |
| बालकनी (बिल्डिंग के अंदर) | 20 ft × 9 ft, RCC slab से ढकी |
| बाहर निकला टेरेस | 20 ft × 5 ft, cantilever, ऊपर शीट रूफ |
...
| दीवारें | 9" बाहर, 4.5" अंदर (कमरे की पार्टीशन) |
...
2. **वॉटरप्रूफिंग**: Bitumen felt + सफ़ेद सीमेंट में चाइना मोज़ेक टाइल्स
3. **भविष्य**: सोलर पैनल लगने पर छत को अपने आप छाया मिलेगी

### दीवारों का ट्रीटमेंट
- बाहर प्लास्टर पर **सफ़ेद weatherproof पेंट** (गर्मी reflect करता है)
...
- Wire mesh भार बाँटती है, फ़र्श टूटने से बचाती है
...
6. **Plinth दीवारें** — पिल्लरों के बीच 9" ईंट की दीवारें +3ft तक
7. **मिट्टी भरना** — plinth के अंदर 6" की परतों में मिट्टी भरो, पानी डालो, कूटो
8. **भरी मिट्टी पर PCC** — 3-4" M15 कंक्रीट, लेवल करो, क्योरिंग
9. **फर्श की slab** — wire mesh बिछाओ, 4" M20 कंक्रीट डालो, 14 दिन क्योरिंग
10. **पिल्लर** — +3ft से +15ft तक ढालो (ज़रूरत हो तो 2 बार में)
11. **दीवारें** — 9" बाहर + 4.5" अंदर की दीवारें उठाओ
12. **ओपनिंग छोड़ना** — शटर, गेट, वेंट, टॉयलेट exhaust की जगह छोड़ो
13. **Lintels ढालना** — सब ओपनिंग + भविष्य की खिड़कियों पर RCC lintels
14. **सीढ़ी बनाना** — Dog-legged, waist slab + steps एक साथ ढालो
...
18. **कंक्रीट डालना** — पूरी slab एक ही बार में डालो (M20, cold joint नहीं आना चाहिए)
19. **क्योरिंग** — slab को कम से कम 21 दिन गीला रखो
20. **प्लम्बिंग** — दीवारों में पाइप डालो (प्लास्टर से पहले)
...
| बाहर की दीवार | 9 inch | दो ईंट |
| अंदर की दीवार | 4.5 inch | एक ईंट |
| पिल्लर | 9" × 12" | पिल्लर |
